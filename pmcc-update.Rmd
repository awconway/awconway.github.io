...
## <i class="fa fa-angle-double-right fa-lg"></i>  [Costs of inadvertent perioperative hypothermia in Australia: A cost-of-illness study](https://www.sciencedirect.com/science/article/pii/S1322769619301891)

<br>

## <i class="fa fa-angle-double-right fa-lg"></i>  [Large expert-curated database for benchmarking document similarity detection in biomedical literature search](https://academic.oup.com/database/article/doi/10.1093/database/baz085/5608006)
