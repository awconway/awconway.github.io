...
<sub>(January 2019 - June 2020)</sub></h2>
...
## <i class="fa fa-angle-double-right fa-lg"></i>  Avoiding and Managing Error in Interventional Radiology Practice: Tips and Tools
- [Link to paper](https://journals.sagepub.com/doi/abs/10.1177/0846537119899215)

<br>

## <i class="fa fa-angle-double-right fa-lg"></i> Accuracy and precision of zero-heat-flux temperature measurements with the 3M™ Bair Hugger™ Temperature Monitoring System: a systematic review and meta-analysis. 
- [Link to paper](https://rdcu.be/b4AoO)
...
- [High flow nasal oxygen for sedation - Connaught New Researcher](https://www.aaronconway.info/HFNO) 
...
- Submitted [grant application](https://auto-fasting.netlify.com)
- Organised linkages with PMCC AI team (led by Dr Bo Wang)
- Developing protocol for a study to develop user-facing components (i.e. the alerts that patients receive), which will ensure the alert system is optimally suited to patient and healthcare team requirements for providing the automated pre-procedure fasting instructions.
...
- Applied similar modeling techniques to a much smaller dataset that we have available now (really need a larger sample).
- Planning a submission to the Medtronic External Research Program to undertake a similar analysis using data from patients who were monitored with capnography while receiving opioids.
...
- Summer students from UofT completed data collection for a study at TGH

## PMCC nurses

- Assisted Shereli Soldevilla to submit application for CAP research grant in November (unsuccessful)
