...
<br>
<div align = "center">
## <i class="fad fa-search fa-lg"></i>  [View](thirst-discomfort/index.html) the full study protocol

## <i class="fa fa-info fa-lg"></i>   [View](thirst-discomfort/screening.html) standard operating procedure for participant recruitment

## <i class="fa fa-info fa-lg"></i>   [View](thirst-discomfort/data-collection.html) standard operating procedure for data collection

## <i class="fad fa-tasks fa-lg"></i>  [Track](https://aconway.dev/thirst-discomfort-screening/) recruitment progress
